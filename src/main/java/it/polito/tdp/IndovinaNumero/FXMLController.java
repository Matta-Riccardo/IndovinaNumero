...
public class FXMLController {
	...
	private Model model;    //importo anche il package corrispondente, e creo il modello nell' EntryPoint per poter essere condiviso dall'intera applicazione (quindi non lo creo nel conreoller)
